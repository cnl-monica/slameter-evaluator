 ...
 * @author esperian
 */
public class BandwidthHistoryTrend extends AbstractModule{
    private static BandwidthHistoryTrend BandwidthHistoryTrendInstance;
    private static CalculateTransferedData calculate= new CalculateTransferedData();
    public static BandwidthHistoryTrend getInstance(){
        
        
        if(BandwidthHistoryTrendInstance==null){
            BandwidthHistoryTrendInstance = new BandwidthHistoryTrend();
            return BandwidthHistoryTrendInstance;
        }else{
    ...
    public void run() {
        ...
        while(true){
                ...
                if(query==null){
                    getJedis().publish("ResponseBandwidthHistoryTrend",ModuleResponse.sentData("BandwidthHistoryTrend", "error", "Some of required attribute is missing").toString());
                }else{
                ...
                getJedis().publish("ResponseBandwidthHistoryTrend",ModuleResponse.sentDataJsonArray("BandwidthHistoryTrend", "ok", finalResult).toString());
                 //System.out.println("|ResponseBandwidthHistoryTrend   | Dáta"+finalResult);
                }
                endT=new Date().getTime();
                //System.out.println("BandwidthHistoryTrend "+(endT-startT));
